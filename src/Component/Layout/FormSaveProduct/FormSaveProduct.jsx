...
export const FormSaveProduct = ({ onChange1, onChange2, onchange3, onchange4, onChange5, onChange6, onChange7, onChange8, onChange9 }) => {
    ...
    function listSuppliers() {
        ...
        const urlRegister = 'http://muebleriaback.herokuapp.com/proveedores/listaProveedores';
        fetch(urlRegister, {
            method: 'GET',
            headers: {
    ...
    function listCategories() {
        const urlRegister = 'http://muebleriaback.herokuapp.com/categorias/listarCategorias';
        fetch(urlRegister, {
            method: 'GET',
            headers: {
                "Content-type": "application/json"
