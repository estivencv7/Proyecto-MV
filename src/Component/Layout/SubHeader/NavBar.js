            ...
            <nav className={navbar ? 'navbar active' : 'navabar'} id='SubHeader'>
                <div className='navbar-container'>
                    ...
                    <nav className='subNav'>
                        ...
                        <Dialog className='cuadro'  visible={visible1} style={{ width: '35%' ,height: '50%'}} onHide={open} header={header3}>
                        ...
                        <Dialog  className='cuadro' visible={visible2} style={{ width: '35%',height: '50%'  }} onHide={open1} header={header2} >
